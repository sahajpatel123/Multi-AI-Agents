...
const CHANGELOG_ENTRIES = [
  {
    date: 'July 2026',
    version: 'v0.7',
    title: 'Ship polish, honest Condura, and primary-flow upgrades',
    badge: {
      label: 'Latest',
      background: '#C4956A',
      color: '#FAF7F4',
    ...
    items: [
      ...
      '[NEW] Shared Agent reports: copy or download standalone EndNote XML citations for direct reference-manager imports',
      ...
      '[NEW] Profile analytics: download or copy the filtered persona win-rate trend as a portable Markdown report, including honest empty-week and omitted-history notes',
      ...
      '[IMPROVED] Arena: Shift+G markdown download refuses empty or malformed rounds, sanitizes filenames, and is duplicate-safe',
      ...
      '[NEW] Arena: copy the full session transcript as CSV (Shift+I)',
      '[IMPROVED] Arena: Shift+I CSV copy writes real text/csv clipboard data with a plain-text fallback, skips empty sessions, and clears stale copy feedback on failure',
      ...
      '[NEW] Motion helpers with prefers-reduced-motion respect across micro-interactions',
      '[NEW] Skip-to-content link, focus-visible rings, and calmer error recovery UI',
      '[IMPROVED] Persona library on the homepage is live (Build your panel) — not “coming soon”',
      '[IMPROVED] Watchlist empty and upgrade states with real next-step CTAs',
      '[IMPROVED] Production config fail-closed (secrets, CORS, Postgres) + health degraded status',
      ...
      '[IMPROVED] Footer status reflects live /api/health instead of a hard-coded green light',
      '[NEW] Offline/online banner so users know when streams will stall',
      '[NEW] Copy all four Arena takes as markdown comparison',
      '[IMPROVED] Discuss mode agent switcher is visible again (was permanently hidden)',
      '[IMPROVED] Arena header UserMenu + profile; Escape closes focused mind',
