...
# See docstring above for the full rationale.
    ...
    ("processed_webhook_events", "id", "CREATE TABLE in migrate_and_start (webhook idempotency ledger)"),
    ("processed_webhook_events", "event_key", "CREATE TABLE in migrate_and_start (webhook idempotency ledger)"),
    ("processed_webhook_events", "event_name", "CREATE TABLE in migrate_and_start (webhook idempotency ledger)"),
    ("processed_webhook_events", "processed_at", "CREATE TABLE in migrate_and_start (webhook idempotency ledger)"),
    ("processed_webhook_events", "expires_at", "CREATE TABLE in migrate_and_start (webhook idempotency ledger)"),
