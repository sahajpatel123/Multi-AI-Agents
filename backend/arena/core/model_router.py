...
TASK_ROUTES = {
    ...
    "prompt_followups": {"primary": "claude_haiku", "fallback": ["claude_sonnet"], "reason": "Follow-up question generation is a lightweight structured-format task. Haiku is fast and cheap."},
