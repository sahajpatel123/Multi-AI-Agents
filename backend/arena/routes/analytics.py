...
async def analytics_summary(
    ...
    avg_session_prompts = 0.0
    if summary_rows:
        avg_session_prompts = sum(row.exchange_count for row in summary_rows) / len(summary_rows)
    ...
    return {
        "total_prompts": int(preference.total_prompts if preference else 0),
        "total_debates": int(preference.total_debates if preference else 0),
        "total_discusses": int(preference.total_discusses if preference else 0),
